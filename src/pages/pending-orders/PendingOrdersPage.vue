<template>
  <q-page class="pending-orders-page q-pa-md">
    ...
    <div v-else-if="filteredOrders.length === 0" class="no-orders-container q-my-xl text-center">
      ...
      <div class="text-h6 q-mt-md text-grey-8">No Pending Orders</div>
      <div class="text-body1 text-grey q-mt-sm">There are no pending orders at this time.</div>
    </div>
      ...
      <q-list separator>
        ...
        >
          <q-item-section>
            ...
            <!-- Order Info -->
            <div class="order-info row q-gutter-x-lg q-mb-sm">
...
import { usePendingOrdersPage } from './PendingOrdersPage.js'
